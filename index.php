...
<html>
  ...
  <body>
    ...
    <script>
      ...
      infospot.addHoverText( 'Minha Linda Arove Nova' );
      ...
      infospot3.position.set( 3457.4, -3744.48, 1956.61 );
      infospot3.addHoverText( 'Minha Linda Arove Nova sei 3' );

      url = 'asset/textures/arvore4.png';

      infospot4 = new PANOLENS.Infospot( 550,  url );
      infospot4.position.set( 3437.4, -3724.48, 1926.61 );
      infospot4.addHoverText( 'Minha Linda Arove Nova sei 4' );
